...
public class DataGenerator {
    ...
    public static String generateCity() {
        var cities = new String[]{
                ...
                "Орёл", "Пенза", "Псков", "Ростов-на-Дону", "Рязань", "Самара", "Саратов", "Южно-Сахалинск", "Екатеринбург",
                "Смоленск", "Тамбов", "Тверь", "Томск", "Тула", "Тюмень", "Ульяновск", "Челябинск", "Ярославль", "Севастополь",
    ...
    public static String generateName(String locale) {
        var faiker = new Faker(new Locale(locale));
        return faiker.name().lastName() + " " + faiker.name().firstName();
    }

    public static String generatePhone(String locale) {
        var faiker = new Faker(new Locale(locale));
        return faiker.phoneNumber().phoneNumber();
    }
